"""MCP server settings: endpoint map, header/url helpers.

純設定常數（BASE_URL、FRONTEND_URL、API_VERSION、DEFAULT_PER_PAGE）
已移至 config.constants，此模組從那裡重新匯出以維持向後相容。
"""

from mcp_buy123_vendor.auth.vendor_login import get_auth_headers
from mcp_buy123_vendor.config.constants import API_VERSION, BASE_URL, DEFAULT_PER_PAGE, FRONTEND_URL
