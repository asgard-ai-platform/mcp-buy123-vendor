...
import time
import requests
from mcp_buy123_vendor.config.settings import get_headers, get_url, DEFAULT_PER_PAGE
    ...
    for attempt in range(retries):
        try:
            ...
            if response.status_code == 401 and require_auth and not auth_retry_used:
                ...
                from mcp_buy123_vendor.auth.vendor_login import invalidate_access_token
